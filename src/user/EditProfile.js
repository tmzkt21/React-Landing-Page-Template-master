...
const EditProfileTypes= {REQUEST: 'EditProfile/REQUEST', SUCCESS: 'EditProfile/SUCCESS', FAIL: 'EditProfile/FAIL'}
const EditProfileRequest = action => ({types: EditProfileTypes.REQUEST, payload: action.payload})
const EditProfileSuccess = action => ({types: EditProfileTypes.SUCCESS, payload: action.payload})
const EditProfileFail = action => ({types: EditProfileTypes.FAIL, payload: action.payload})

const EditProfileReducer = (state, action) => {
    switch (action.type) {
        case EditProfileTypes.REQUEST:
            return {
                ...state, payload: action.payload
            }
        case EditProfileTypes.SUCCESS:
            return {
                ...state, payload: action.payload
            }
        case EditProfileTypes.FAIL:
            return {
                ...state, payload: action.payload
            }
        default:
